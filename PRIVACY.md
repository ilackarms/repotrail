...
tokenized URL is stored in `~/.repotrail/ports.json` so your local Claude Code
harness can connect to the correct VS Code window.
...
sends depends on the tools and model configuration in your Claude Code session.
